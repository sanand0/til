...
- Project ideas:
  ...
  - Generate and add `q-transcribe-numbers`. Serve a truly random 40-digit number as .wav (concatenating digit wavs on the server). Students' answer is hash-validated on the client AND server.

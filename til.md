...
- 18 Feb 2026. Scanning browsing history seems the best way for me to remember what I did on a given day. For example, running `datasette ~/.config/microsoft-edge/Default/History --nolock` and then this SQL query let me see what I did over the weekend.
  ```sql
  SELECT
  ...
  WHERE visit_date >= '2026-02-14 00:00:00'
    AND visit_date <= '2026-02-15 23:59:59'

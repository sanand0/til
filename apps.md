...
- [ ] 25 Mar 2026. Create a UMAP embedding of a music library using Gemini 2 embeddings (max 80 seconds, mp3/wav). How does this compare with our notion of music similarities?
...
- [x] 26 Feb 2026. Mayank. Spawn an instance to run DBT rules other code from SchemaForge, or other examples. The point is spawning.
...
- [x] 26 Feb 2026. Anand. Agentic chatbot: actually complete tasks (like filing financial aid forms)
...
- [x] 24 Dec 2025. Ritesh. OlmoEarth insights. Which region in Bangalore became urbanized fastest? https://ritesh17rb.github.io/olmo-earth/
- [x] 14 Dec 2025. Nitin. Better SVG to doodle animation library. Convert to paths. Realistic speed.
